export const icons = {
  ...
  drivers: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    <path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/>
  </svg>`,
  facilities: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    <path d="M12 7V3H2v18h20V7H12zM6 19H4v-2h2v2zm0-4H4v-2h2v2zm0-4H4V9h2v2zm0-4H4V5h2v2zm4 12H8v-2h2v2zm0-4H8v-2h2v2zm0-4H8V9h2v2zm0-4H8V5h2v2zm10 12h-8v-2h2v-2h-2v-2h2v-2h-2V9h8v10zm-2-8h-2v2h2v-2zm0 4h-2v2h2v-2z"/>
  </svg>`,
  incidents: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
  ...
  route: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    <path d="M19.94 21.12c-1.1-2.94-1.64-6.03-1.64-9.12 0-3.09 0.54-6.18 1.64-9.12 0.04-0.11 0.06-0.22 0.06-0.34 0-0.65-0.53-1.18-1.18-1.18-0.49 0-0.91 0.3-1.09 0.73-1.04 2.79-1.56 5.74-1.56 8.91 0 3.17 0.52 6.12 1.56 8.91 0.18 0.43 0.6 0.73 1.09 0.73 0.65 0 1.18-0.53 1.18-1.18 0-0.12-0.02-0.23-0.06-0.34zM4.06 21.12c-0.04 0.11-0.06 0.22-0.06 0.34 0 0.65 0.53 1.18 1.18 1.18 0.49 0 0.91-0.3 1.09-0.73 1.04-2.79 1.56-5.74 1.56-8.91 0-3.17-0.52-6.12-1.56-8.91-0.18-0.43-0.6-0.73-1.09-0.73-0.65 0-1.18 0.53-1.18 1.18 0 0.12 0.02 0.23 0.06 0.34 1.1 2.94 1.64 6.03 1.64 9.12 0 3.09-0.54 6.18-1.64 9.12z"/>
  </svg>`,
  totalFleet: `<svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
    <path d="M20 8h-3V4H3c-1.1 0-2 .9-2 2v11h2c0 1.66 1.34 3 3 3s3-1.34 3-3h6c0 1.66 1.34 3 3 3s3-1.34 3-3h2v-5l-3-4zM6 18.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm13.5-9l1.96 2.5H17V9.5h2.5zm-1.5 9c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/>
  </svg>`,
  activeFleet: `<svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/>
  </svg>`,
  utilization: `<svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor">
  ...
  refresh: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
    <path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/>
  </svg>`,
  document: `<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
