<script lang="ts">
  ...
  // Get maintenance ID from URL parameter
  const maintenanceId = $page.params.id;
  ...
  const maintenance: MaintenanceLog = {
    ...
    cost: 2500.75,
    notes: "Regular maintenance check including oil change, brake inspection, and tire rotation. All systems functioning normally.",
    mechanic: "Alan Michaels",
    location: "Golden Auto Shop, Albany, NY",
...
<svelte:head>
  <title>Maintenance Details | {maintenance.truck.truck_number} | Waybill</title>
</svelte:head>
